...
public class CarritoAñadirView extends JInternalFrame {
    ...
    public CarritoAñadirView(){
        super("Añadir al Carrito", true, true, true, false);
        initComponents();
    ...
    private void initComponents() {
        ...
        cbxCantidad = new JComboBox<>(cantidades);
        gbc.gridx = 1;
        panelPrincipal.add(cbxCantidad, gbc);
        ...
        panelPrincipal.add(new JScrollPane(tblCarrito), gbc);
    ...
    public JTable     getTableCarrito()      { return tblCarrito; }
